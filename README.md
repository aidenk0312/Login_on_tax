...
1. Swagger 주소: http://localhost:8080/swagger-ui
...
3. 검증 결과: 프로젝트를 통해 각 API의 기능이 정상적으로 동작하고, 요구사항이 정확하게 구현되었음을 확인하였습니다.
...
5. 구현 시 중요하게 고려한 부분
 ...
 - 의존성 주입: 생성자를 통해 필요한 서비스와 유틸리티 클래스의 인스턴스를 주입받아 사용하였습니다. 이렇게 하여 클래스간 결합도를 낮추고 유연한 구조를 유지하였습니다.
 - JWT 인증: JWT(Json Web Token)를 사용하여 사용자 인증을 구현하였습니다. 이를 통해 사용자 인증 정보를 안전하게 전달하고 유효성 검사를 수행할 수 있습니다.
